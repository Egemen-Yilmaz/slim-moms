...
const swaggerDocument = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "Slim Moms Sağlıklı Beslenme ve Kalori Takip Uygulaması API Dökümantasyonu",
  },
  servers: [
    {
  ...
  paths: {
    "/api/auth/register": {
      post: {
        ...
        responses: {
          201: {
            description: "Kullanıcı başarıyla oluşturuldu ve tokenlar döndü.",
          },
        },
      },
    },
...
app.use((req, res) => {
  res
    .status(404)
    .json({ status: "fail", message: "İstediğiniz rota bulunamadı." });
});
